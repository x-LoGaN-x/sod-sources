...
int main()
{
   ...
   char *params[7] = {(char *)"May", (char *)"The", (char *)"Force", (char *)"Be", (char *)"With", (char *)"You", NULL};
   ...
   else if (luke == 0)
   {
      ...
      reply = execv("./10.2_fork_execv_figlio", params);
      if (reply < 0)
      {
         cerr << "IT'S A TRAP!!! Errore nella chiamata execv" << endl;
         perror("Details");
         exit(-1);
      }
   }
