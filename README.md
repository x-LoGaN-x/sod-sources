...
```
cd existing_repo
git remote add origin https://gitlab.idea-on-line.it/d.marcozzi/sistemi-operativi-dedicati-sorgenti.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.idea-on-line.it/d.marcozzi/sistemi-operativi-dedicati-sorgenti/-/settings/integrations)
